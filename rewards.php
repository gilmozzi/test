        ...
        <div class="col-md-12">
            <div class="promo2">
                <div class="row">
                    ...
                    <h3> FREE  <br> <span class="food-ticket">PRIZES?</span></h3>
                </div>

                <div class="row">
                    <p> Apply Below to be entered into monthly drawings.</p>
                </div>

                <form id="prmForm" method="post" target="_self">
                    <label for="rew_name"><h5><b>Name</h5></b></label>
                    <br>
                    <input type="text" required name="name"/>
                    <br>
                    <label for="rew_email"><h5><b>Email</h5></b></label>
                    <br>
                ...
                //error_reporting(E_ALL);
                  ...
                  if (isset($_POST['name'])) {
                    require "rewards_submit.php";
                    if ($_RSV->save($_POST['name'],
                      $_POST['email'])) {
                      echo "<div class='ok'>Your ballot has been saved. You have been placed in the next drawing and will be emailed if you win!</div>";
