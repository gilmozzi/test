    ...
    <div class="body-for-newthread">
      ...
      <div class="banner">
        ...
        <div class="your-question">
          <div class="question-wrap">
            <div class="asking-question">
                <div class="question-title">
                  <h1 class="thank-you">Thanks for your <span>Question!</span></h1>
                </div>
          ...
          $time = time();
          mysqli_query($conn,"INSERT INTO faq VALUES('$_POST[message]')");

          echo "<div class='threads-posted'><p>Question Successfully Posted!</p><br><a href='faq.php'>Return</a></div>";
          ?>
